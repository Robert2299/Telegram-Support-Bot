...
ddef markup_main():
    ...
    item1 = types.KeyboardButton("✏️ Write a Request")
    item2 = types.KeyboardButton("✉️ My Requests")
...
def markup_agent():
    ...
    item1 = types.InlineKeyboardButton("❗️ Awaiting Support Response", callback_data='waiting_reqs:1')
    item2 = types.InlineKeyboardButton("⏳ Awaiting User Response", callback_data='answered_reqs:1')
    item3 = types.InlineKeyboardButton("✅ Completed Requests", callback_data='confirm_reqs:1')
...
def markup_admin():
    ...
    item1 = types.InlineKeyboardButton("✅ Add Support Agent", callback_data='add_agent')
    item2 = types.InlineKeyboardButton("🧑‍💻 Support Agents", callback_data='all_agents:1')
    item3 = types.InlineKeyboardButton("🔑 One-Time Passwords", callback_data='all_passwords:1')
    item4 = types.InlineKeyboardButton("🎲 Generate One-Time Passwords", callback_data='generate_passwords')
    item5 = types.InlineKeyboardButton("⛔️ Turn Off the Bot", callback_data='stop_bot:wait')
...
def markup_request_action(req_id, req_status, callback):
    ...
    def markup_request_action(req_id, req_status, callback):
        ...
        if req_status == 'confirm':
            item1 = types.InlineKeyboardButton("🗂 Show Files", callback_data=f'req_files:{req_id}:{callback}:1')
            ...
            item1 = types.InlineKeyboardButton("✏️ Add Message", callback_data=f'add_message:{req_id}:{status_user}')
            item2 = types.InlineKeyboardButton("🗂 Show Files", callback_data=f'req_files:{req_id}:{callback}:1')

            if status_user == 'user':
                item3 = types.InlineKeyboardButton("✅ Confirm Request", callback_data=f'confirm_req:wait:{req_id}')
    ...
    def markup_confirm_req(req_id):
        ...
        item1 = types.InlineKeyboardButton("✅ Confirm", callback_data=f'confirm_req:true:{req_id}')
